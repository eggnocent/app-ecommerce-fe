...
/**
 * @generated from protobuf message order.CreateProductRequestProductItem
 */
export interface CreateProductRequestProductItem {
    /**
...
export interface CreateOrderRequest {
    ...
    notes: string;
    /**
     * @generated from protobuf field: repeated order.CreateProductRequestProductItem products = 5;
     */
    products: CreateProductRequestProductItem[];
}
/**
...
export interface ListOrderAdminResponseItem {
    ...
    createdAt?: Timestamp;
    /**
     * @generated from protobuf field: repeated order.ListOrderAdminResponseItemProduct product = 7;
     */
    product: ListOrderAdminResponseItemProduct[];
}
/**
...
export interface ListOrderResponseItem {
    ...
    createdAt?: Timestamp;
    /**
     * @generated from protobuf field: repeated order.ListOrderResponseItemProduct product = 7;
     */
    product: ListOrderResponseItemProduct[];
    /**
...
class CreateProductRequestProductItem$Type extends MessageType<CreateProductRequestProductItem> {
    constructor() {
        super("order.CreateProductRequestProductItem", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "quantity", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<CreateProductRequestProductItem>): CreateProductRequestProductItem {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "";
        message.quantity = 0n;
        if (value !== undefined)
            reflectionMergePartial<CreateProductRequestProductItem>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateProductRequestProductItem): CreateProductRequestProductItem {
    ...
    internalBinaryWrite(message: CreateProductRequestProductItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
...
/**
 * @generated MessageType for protobuf message order.CreateProductRequestProductItem
 */
export const CreateProductRequestProductItem = new CreateProductRequestProductItem$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateOrderRequest$Type extends MessageType<CreateOrderRequest> {
    constructor() {
        super("order.CreateOrderRequest", [
            ...
            { no: 5, name: "products", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CreateProductRequestProductItem }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string notes */ 4:
                    ...
                    break;
                case /* repeated order.CreateProductRequestProductItem products */ 5:
                    message.products.push(CreateProductRequestProductItem.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CreateOrderRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated order.CreateProductRequestProductItem products = 5; */
        for (let i = 0; i < message.products.length; i++)
            CreateProductRequestProductItem.internalBinaryWrite(message.products[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ListOrderAdminResponseItem$Type extends MessageType<ListOrderAdminResponseItem> {
    constructor() {
        super("order.ListOrderAdminResponseItem", [
            ...
            { no: 7, name: "product", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderAdminResponseItemProduct }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp created_at */ 6:
                    ...
                    break;
                case /* repeated order.ListOrderAdminResponseItemProduct product */ 7:
                    message.product.push(ListOrderAdminResponseItemProduct.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ListOrderAdminResponseItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated order.ListOrderAdminResponseItemProduct product = 7; */
        for (let i = 0; i < message.product.length; i++)
            ListOrderAdminResponseItemProduct.internalBinaryWrite(message.product[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ListOrderAdminResponse$Type extends MessageType<ListOrderAdminResponse> {
    constructor() {
        super("order.ListOrderAdminResponse", [
            ...
            { no: 3, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderAdminResponseItem }
        ]);
    }
...
class ListOrderResponseItem$Type extends MessageType<ListOrderResponseItem> {
    constructor() {
        super("order.ListOrderResponseItem", [
            ...
            { no: 5, name: "total", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 6, name: "created_at", kind: "message", T: () => Timestamp },
            { no: 7, name: "product", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderResponseItemProduct },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp created_at */ 6:
                    message.createdAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.createdAt);
                    break;
                case /* repeated order.ListOrderResponseItemProduct product */ 7:
                    message.product.push(ListOrderResponseItemProduct.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: ListOrderResponseItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.createdAt)
            Timestamp.internalBinaryWrite(message.createdAt, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* repeated order.ListOrderResponseItemProduct product = 7; */
        for (let i = 0; i < message.product.length; i++)
            ListOrderResponseItemProduct.internalBinaryWrite(message.product[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
...
class ListOrderResponse$Type extends MessageType<ListOrderResponse> {
    constructor() {
        super("order.ListOrderResponse", [
            { no: 1, name: "base", kind: "message", T: () => BaseResponse },
            { no: 2, name: "pagination", kind: "message", T: () => PaginationResponse },
            { no: 3, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderResponseItem }
        ]);
    }
