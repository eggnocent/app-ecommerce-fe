...
import type { CreatedProductResponse } from "./product";
...
export interface IProductServiceClient {
    /**
     * @generated from protobuf rpc: CreateProduct(product.CreateProductRequest) returns (product.CreatedProductResponse);
     */
    createProduct(input: CreateProductRequest, options?: RpcOptions): UnaryCall<CreateProductRequest, CreatedProductResponse>;
    /**
...
export class ProductServiceClient implements IProductServiceClient, ServiceInfo {
    ...
    createProduct(input: CreateProductRequest, options?: RpcOptions): UnaryCall<CreateProductRequest, CreatedProductResponse> {
        ...
        return stackIntercept<CreateProductRequest, CreatedProductResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: DetailProduct(product.DetailProductRequest) returns (product.DetailProductResponse);
     */
