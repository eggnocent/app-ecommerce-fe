...
/**
 * @generated from protobuf message product.CreatedProductResponse
 */
...
// @generated message type with reflection information, may provide speed optimized methods
class CreatedProductResponse$Type extends MessageType<CreatedProductResponse> {
    constructor() {
        super("product.CreatedProductResponse", [
            { no: 1, name: "base", kind: "message", T: () => BaseResponse },
            { no: 2, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<CreatedProductResponse>): CreatedProductResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "";
        if (value !== undefined)
            reflectionMergePartial<CreatedProductResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreatedProductResponse): CreatedProductResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CreatedProductResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message product.CreatedProductResponse
 */
export const CreatedProductResponse = new CreatedProductResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class ListProductResponse$Type extends MessageType<ListProductResponse> {
    constructor() {
        super("product.ListProductResponse", [
            ...
            { no: 3, name: "data", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListProductResponseItem }
        ]);
    }
...
class ListProductAdminResponse$Type extends MessageType<ListProductAdminResponse> {
    constructor() {
        super("product.ListProductAdminResponse", [
            { no: 1, name: "base", kind: "message", T: () => BaseResponse },
            { no: 2, name: "pagination", kind: "message", T: () => PaginationResponse },
            { no: 3, name: "data", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListProductAdminResponseItem }
        ]);
    }
...
class HighlightProductsResponse$Type extends MessageType<HighlightProductsResponse> {
    constructor() {
        super("product.HighlightProductsResponse", [
            { no: 1, name: "base", kind: "message", T: () => BaseResponse },
            { no: 2, name: "data", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HighlightProductsResponseItem }
        ]);
    }
...
export const ProductService = new ServiceType("product.ProductService", [
    { name: "CreateProduct", options: {}, I: CreateProductRequest, O: CreatedProductResponse },
